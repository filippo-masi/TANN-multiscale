...
#                      Data-generation                    #
###########################################################
increments = 100 # number of increments
n_reset= 100 # number of increments before reset
       

dep = np.zeros((increments,6)) # strain increments

de = 5.e-1 # magnitude of the strain increments

# Define strain increment path
dep[:,0] = de*np.random.normal(0,de,(increments))
